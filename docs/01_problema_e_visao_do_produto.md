...
- **Quem são os usuários?**  
  Proprietários de pequenos comércios, funcionários responsáveis pelo estoque e administradores do sistema.

- **Em que ambiente o problema ocorre?**  
  Em lojas, mercados, papelarias, farmácias, almoxarifados e outros ambientes que precisam controlar produtos armazenados.

- **Quais dificuldades atuais existem?**  
  Falta de atualização em tempo real, dificuldade para localizar produtos, erros no registro de entradas e saídas, risco de ruptura de estoque e baixa visibilidade sobre a quantidade disponível.

- **Que impacto a solução pode gerar?**  
  A solução pode melhorar a organização do negócio, reduzir perdas, agilizar a tomada de decisão, facilitar o acompanhamento do estoque e aumentar a eficiência operacional.
...
|---|---|---|
| Usuário final | Funcionário ou responsável pelo estoque | Registrar e consultar produtos com facilidade e rapidez |
| Cliente/solicitante | Pequeno comércio ou responsável pela operação | Melhorar o controle dos itens e reduzir erros e perdas |
| Equipe do projeto | Desenvolvedores e responsáveis pela documentação | Aplicar os conceitos da disciplina e entregar uma solução funcional |
